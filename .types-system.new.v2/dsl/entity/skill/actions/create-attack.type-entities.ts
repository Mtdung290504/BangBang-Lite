...
interface CreateImpactorBase<T extends string = string>
	extends
		Impactable<T>,
 ...
 */
export interface CreateImpactor<T extends string = string>
	extends
		CreateImpactorBase<T>,
 ...
 */
export interface CreateTargetedImpactor<T extends string = string>
	extends CreateImpactorBase<T>, UseTargetingStrategy, RequireInitPositionMethod, Movable {}
