...
export default class RenderSystemsManager {
	...
	renderAll() {
		...
		// Nhóm systems theo primaryComponents (tối đa hóa, không cần liền kề)
		const systemGroups = this._groupSystemsByComponents();
	 ...
	 */
	getSystemGroups() {
		const groups = this._groupSystemsByComponents();
