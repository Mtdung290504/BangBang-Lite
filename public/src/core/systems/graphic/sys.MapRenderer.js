...
/**
 * Note: với system không có component, nó được xem là service system, eID là -1, components là []
 */
const MapRenderer = defineSystemFactory([], MapRenderContext)
	.withProcessor((_context, _eID, [], sysContext) => {
